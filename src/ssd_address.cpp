...
Address::Address(unsigned int package, unsigned int die, unsigned int plane, unsigned int block, unsigned int page, enum address_valid valid):
	package(package),
	die(die),
	plane(plane),
	block(block),
...
enum address_valid Address::check_valid(unsigned int ssd_size, unsigned int package_size, unsigned int die_size, unsigned int plane_size, unsigned int block_size)
{
