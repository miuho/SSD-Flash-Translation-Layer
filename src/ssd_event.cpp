...
Event::Event(enum event_type type, unsigned long logical_address, unsigned int size, double start_time):
...
unsigned long Event::get_logical_address(void) const
{
...
unsigned int Event::get_size(void) const
{
	return size;
}
